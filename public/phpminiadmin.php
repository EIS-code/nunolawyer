...
$ACCESS_PWD='Shiv'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access
...
'user'=>"Consultant",#required

'pwd'=>"Portugal@2020", #required

'db'=>"db_consult",  #optional, default DB
